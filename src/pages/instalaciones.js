...
const Instalaciones = ({ data }) => {
  const classes = useStyles();
  return (
    <Layout>      
      <Helmet title="Instalaciones eléctricas, fontanería, climatización y calefacción." defer={false} />
      <Parallax /*image={require("public/img/bg8.jpg")}*/ filter="info" small>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={6} md={6}>
              <h1 className={classes.title}>Instalaciones</h1>
            </GridItem>
          </GridContainer>
        </div>
      </Parallax>
